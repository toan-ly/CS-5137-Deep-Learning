...
def extract_small_vessel(gt_mask, kernel_size=3, struct_elem='ellipse'):
    """
    ...
    kernel = cv2.getStructuringElement(struct_elem_map[struct_elem], (kernel_size, kernel_size))
